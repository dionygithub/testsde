 ...
 *
 * @Block(
 *   id = "admin_tests_valorados_block",
 *   admin_label = @Translation("Tests Valorados Block"),
 * )
 */
class TestsValoradosBlock extends BlockBase {
    /**
     * {@inheritdoc}
     */
    public function build() {
        ...
        $output = $adminTestsController->getHtmlTestsValorados();
        $htmlTestRelac = [
            '#theme' => 'block_tests_valorados',
            '#data' => array('testsValorados'=>$output),
        ];
